    ...
    <>
      ...
      <Panel>
        <div className="flex flex-col md:flex-row md:items-center">
          <h3 className=" whitespace-nowrap mb-3 md:mb-0">Past burns</h3>

          <div className="flex items-center justify-between space-x-8 md:ml-auto">
            <div className="flex items-center space-x-3">
              <div className="text-xs ">Show tiny burns</div>
              <Toggle
                active={showTiny}
        ...
        <div className="-mx-5">
          <Table
            ...
            noDataMessage={
              kit.defaultAccount
                ? 'No burns found'
                : 'Need to connect an account before viewing burns'
            }
            rows={burns.map((node) => {
